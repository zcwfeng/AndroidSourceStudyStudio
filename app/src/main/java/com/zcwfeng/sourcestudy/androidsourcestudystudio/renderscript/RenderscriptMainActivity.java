...
package com.zcwfeng.sourcestudy.androidsourcestudystudio.renderscript;
...
public class RenderscriptMainActivity extends BaseActivity {
...
//    private ScriptC_saturation mScript;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.renderscript_main_layout);

        /*
         * Initialize UI
         */
        mBitmapIn = loadBitmap(R.mipmap.data);
