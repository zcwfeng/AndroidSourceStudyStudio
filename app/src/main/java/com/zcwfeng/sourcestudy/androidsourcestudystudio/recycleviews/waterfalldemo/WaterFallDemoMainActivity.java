...
public class WaterFallDemoMainActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        startActivity(new Intent(this, WaterFlallMainActivity.class));
        finish();
   ...
   /* @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.aaa_menu_main, menu);
        return true;
    }
    @Override
