package com.zcwfeng.sourcestudy.androidsourcestudystudio.stickynavlayout;
...
public class StickNavLayoutMainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stick_nav_main);
