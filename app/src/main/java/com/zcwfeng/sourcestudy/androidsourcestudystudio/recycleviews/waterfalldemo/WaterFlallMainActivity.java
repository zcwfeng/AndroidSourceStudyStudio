 ...
 * @date 2015/4/6
 */
public class WaterFlallMainActivity extends BaseActivity implements ResponseCallback {
    ...
    private void setSwipeRefreshLayout() {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (!isLoadingData) {
                    //Log.d(TAG, "加载新的数据");
                    mDataManager.loadNewData(WaterFlallMainActivity.this);
                    isLoadingData = true;
                }
            }
        });
    ...
    private void setWaterFallRcv() {
        ...
        waterFallRcv.addOnScrollListener(new OnRecyclerViewScrollListener() {
            ...
            public void onBottom() {
                //Log.d(TAG, "on bottom");
                Toast.makeText(WaterFlallMainActivity.this, "bottom", Toast.LENGTH_SHORT).show();
                // 到底部自动加载
                if (!isLoadingData) {
                    isLoadingData = true;
                    Log.d(TAG, "loading old data");
                    mDataManager.loadOldData(WaterFlallMainActivity.this);
        ...
        waterFallRcv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(WaterFlallMainActivity.this, "on click", Toast.LENGTH_SHORT).show();
        ...
        waterFallRcv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(WaterFlallMainActivity.this, "on long click", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
